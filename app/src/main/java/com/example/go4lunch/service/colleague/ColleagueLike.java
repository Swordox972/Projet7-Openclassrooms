...
public class ColleagueLike {
    ...
    public static List<Colleague> setThreePeopleLikes() {
        ...
        colleagueLikeList.add(scarlett);       colleagueLikeList.add(hugh);
    ...
    public static List<Colleague> setFivePeopleLikes() {
        ...
        List<Colleague> colleagueLikeList= new ArrayList<>();
        colleagueLikeList.add(scarlett);           colleagueLikeList.add(hugh);
        colleagueLikeList.add(nana);               colleagueLikeList.add(godfrey);
    ...
    public static List<Colleague> setSevenPeopleLike() {
        ...
        colleagueLikeList.add(scarlett);       colleagueLikeList.add(hugh);
        colleagueLikeList.add(nana);       colleagueLikeList.add(godfrey);
        colleagueLikeList.add(henry);       colleagueLikeList.add(angelina);
